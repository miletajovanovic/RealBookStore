...
public class CommentRepository {
    ...
    public void create(Comment comment) {
        ...
        try (Connection connection = dataSource.getConnection();
        	...
        	auditLogger.audit("Added comment " + comment);
        } catch (SQLException e) {
        	LOG.warn("Failed to add comment " + comment, e);
        	auditLogger.audit("Failed to add comment " + comment);
        }
    }
    ...
    public List<Comment> getAll(int bookId) {
        ...
        try (Connection connection = dataSource.getConnection();
        	...
        	LOG.warn("Failed to get all comments for bookId: " + bookId, e);
        }
        return commentList;
    }
}
