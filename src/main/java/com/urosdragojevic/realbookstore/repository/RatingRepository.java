...
public class RatingRepository {
    ...
    public void createOrUpdate(Rating rating) {
        ...
        try (Connection connection = dataSource.getConnection();
        	...
        	auditLogger.audit("Updated or created a rating for book with id: " + rating.getBookId() + " and userId: " + rating.getUserId());
        } catch (SQLException e) {
        	LOG.warn("Failed to update or create a rating for book with id: " + rating.getBookId() + " and userId: " + rating.getUserId(), e);
        	auditLogger.audit("Failed to update or create a rating for book with id: " + rating.getBookId() + " and userId: " + rating.getUserId());
        }
    }
    ...
    public List<Rating> getAll(int bookId) {
        ...
        try (Connection connection = dataSource.getConnection();
        	...
        	LOG.warn("Failed to get all ratings", e);
        }
        return ratingList;
    }
